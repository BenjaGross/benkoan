...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Extra Credit:
    # Injecct iterates throught he array performing the actions described in the block and starts with the argument passed directly to inject
  end
  ...
  #     # code to read 'file'
  #   end
  ## This is done so file changes like a pointer as opposed to a 
